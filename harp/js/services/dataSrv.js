...
app.factory('dataSrv', function($http, $resource, $rootScope) {
	...
	var Raccount = $resource('/:publ/:version/account/:method', {version: '0.1'}, {
		...
		sessionGet: {method: 'GET', cache: false, params: {publ:'openapi', method: 'sessionGet'}},
		...
		updatePasswd: {method: 'POST', cache: false, params: {publ:'openapi', method: 'updatePasswd'}},
		...
		vacansyRemove: {method: 'POST', cache: false, params: {publ:'api', method: 'vacansyRemove'}},
		...
		blacklistGet: {method: 'GET', cache: false, params: {publ:'api', method: 'blacklistGet'}},
		blacklistAdd: {method: 'POST', cache: false, params: {publ:'api', method: 'blacklistAdd'}},
		blacklistRemove: {method: 'POST', cache: false, params: {publ:'api', method: 'blacklistRemove'}},
		watchlistGet: {method: 'GET', cache: false, params: {publ:'api', method: 'watchlistGet'}},
		watchlistAdd: {method: 'POST', cache: false, params: {publ:'api', method: 'watchlistAdd'}},
		watchlistRemove: {method: 'POST', cache: false, params: {publ:'api', method: 'watchlistRemove'}},
		remove: {method: 'POST', cache: false, params: {publ:'api', method: 'remove'}},
		confirmSend: {method: 'POST', cache: false, params: {publ:'api', method: 'confirmSend'}},
		confirmInput: {method: 'POST', cache: false, params: {publ:'api', method: 'confirmInput'}}
	});
	...
	var Rrespond = $resource('/:publ/:version/respond/:method', {version: '0.1', publ: 'api'}, {
		send: {method: 'POST', cache: true, params: {method: 'send'}},
		get: {method: 'GET', cache: true, params: {method: 'get'}}, // id: id акка
		getById: {method: 'GET', cache: true, params: {method: 'getById'}}, // id: id собеседования
		accept: {method: 'POST', cache: true, params: {method: 'accept'}}, // id: id собеседования, time: String  //выбранное время собеседования
		decline: {method: 'POST', cache: true, params: {method: 'decline'}}, // id: id собеседования, time: String  //выбранное время собеседования
...
*/
	...
	return {
						...
						if(!a2.error) {
							...
							var ready = function() {
								Raccount.sessionGet({}, function(a3) {
									if(!a3.error) {
										$.session = a3.result;
										$rootScope._data.session = $.session;
										$rootScope.$emit('sessionUpdate', $.session);
										cb(a3.error, true);
										$rootScope._data.lists = $._lists;
										$.ready = true;
		...
		phoneGetCode: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.confirmSend({phone:args}, function(data) {
		...
		phoneConfirm: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.confirmInput({code:args}, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		sendRespond: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Rrespond.send(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		getRespond: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Rrespond.get(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},

		getRespondById: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Rrespond.getById(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},

		acceptRespond: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Rrespond.accept(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},

		declineRespond: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Rrespond.decline(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		getBlacklist: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.blacklistGet({}, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		addToBlacklist: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.blacklistAdd(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},

		removeOfBlacklist: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.blacklistRemove(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		getWatchlist: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.watchlistGet({}, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		addToWatchlist: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.watchlistAdd(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},

		removeOfWatchlist: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.watchlistRemove(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		getVacansyById: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.vacansyGetById(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		removeVacansy: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.vacansyRemove({vacansyId:args.id||args.vacansy}, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		acceptInterview: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Rinterview.accept(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},

		declineInterview: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Rinterview.decline(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		inviteInterview: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Rinterview.invite(args, function(data) {
				cb(data.error, data.result);
			});
			return $;
		},
		...
		remind: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.updatePasswd(args, function(data) {
				cb(data.error, true);
			});
			return $;
		},
		accountUpdate: function() {
			var $=this,args=arguments[0]||{},cb=arguments[1]||function(){};
			Raccount.update({changes:JSON.stringify(args)}, function(data) {
				cb(data.error, true);
			});
			return $;
		},
		...
		updateProfile: function() {
			...
			Raccount.profileUpdate({
				changes: JSON.stringify(clone(args))
			}, function(data) {
				cb(data.error, data.result);
			});
			return $;
